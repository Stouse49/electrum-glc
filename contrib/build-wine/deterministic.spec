...
exe_standalone = EXE(
    ...
    console=False)
    # console=True makes an annoying black box pop up, but it does make Electrum-GLC output command line commands, with this turned off no output will be given but commands can still be used
